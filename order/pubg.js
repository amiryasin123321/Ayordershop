...
function showItems(category) {
        ...
        productData[category].forEach(item => {
            ...
            itemElement.innerHTML = `
                ...
                <button class="add-to-cart" onclick="addToCart('${item.name}', '${item.price}')">
                    <img src="https://cdn-icons-png.flaticon.com/512/1170/1170678.png" alt="Add to Cart" width="20">
                </button>
            `;
    ...
    // Animate the swipe line to the active category
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    showItems('PUBG-UC'); // Set a default category
});